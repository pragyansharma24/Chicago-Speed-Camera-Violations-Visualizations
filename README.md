...
* Line charts are often the preferred chart type for showing trends in the data, and blue color is the standard chart color. During the data-exploration phase of this project, red-blue colormap for this chart was used; However, it is realized that colors are actually not required and may distract the reader. Single color is eventually preferred for the final version. 
