...
Figure 1 shows that since the installation of automated speed cameras in safety zones, total speed violations reported by all cameras are on decline. In general, this can be attributed to two major factors: 
